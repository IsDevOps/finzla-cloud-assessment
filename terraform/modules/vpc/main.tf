# Minimal VPC: public subnets for the ALB, private subnets for the ECS
# tasks. Tasks never get a public IP — outbound access (pulling images,
# calling AWS APIs) goes through the NAT gateway(s) below.
